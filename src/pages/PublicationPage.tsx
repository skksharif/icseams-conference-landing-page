        ...
        <div className="max-w-4xl mx-auto">
          <div className="mb-12" data-aos="fade-up">
            ...
            <p className="text-gray-700 mb-6 text-justify">
              ICSEAMS-2026 offers authors the opportunity to have their research
              papers published in reputed Scopus and Web of Science indexed
              journals or in the conference proceedings. All submitted papers
              undergo a rigorous triple peer-review process to ensure
            ...
            <div className="space-y-6">
              <div className="flex flex-col md:flex-row gap-4 items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-700 text-justify">
                    Authors submit their full papers following the conference
                    template and guidelines. Papers must be original and not
                    published elsewhere.
                  </p>
                </div>
              </div>
              ...
              <div className="flex flex-col md:flex-row gap-4 items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-700 text-justify">
                    ...
                    from the technical committee. The review process is
                    double-blind to ensure fairness and quality.
                  </p>
                </div>
              </div>
              ...
              <div className="flex flex-col md:flex-row gap-4 items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-700 text-justify">
                    Authors receive reviewer feedback and may be asked to revise
                    their papers. Final acceptance is based on addressing
                    reviewer comments and meeting quality standards.
                  </p>
                </div>
              </div>
              ...
              <div className="flex flex-col md:flex-row gap-4 items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-700 text-justify">
                    Accepted papers are allocated to appropriate journals based
                    on their quality, relevance, and scope alignment. Authors
                    may indicate their preferred journal during submission.
                  </p>
                </div>
              </div>
              ...
              <div className="flex flex-col md:flex-row gap-4 items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-700 text-justify">
                    Accepted papers are published in the selected journals or
                    conference proceedings following author registration and
          ...
          <div className="mb-12" data-aos="fade-up">
            ...
            <p className="text-gray-700 mb-6 text-justify">
              ...
              published in the official ICSEAMS-2026 conference proceedings. The
              proceedings will be:
            </p>
          ...
          >
            ...
            <p className="text-gray-700 mb-4 text-justify">
              ICSEAMS-2026 follows strict publication ethics and standards to
              ensure the integrity of the scientific record. Authors must adhere
              to the following:
            </p>
            <ul className="space-y-2 text-gray-700">
              <li className="flex items-start">
              ...
              <li className="flex items-start">
                <span className="inline-block w-2 h-2 bg-conference-green rounded-full mt-2 mr-2"></span>
                Adherence to ethical guidelines for research involving humans or
                animals
              </li>
            </ul>
          </div>
