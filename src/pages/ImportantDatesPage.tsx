        ...
        <div className="max-w-3xl mx-auto">
          <div className="mb-8 text-center" data-aos="fade-up">
            <p className="text-gray-700">
              ...
              ICSEAMS-2026. Mark your calendars and ensure timely submissions to
          ...
          <div className="space-y-4 mb-12">
            ...
            <DateItem
              ...
              date={(<strong>November 3, 2025</strong>) as any}
              delay={100}
            />
            <DateItem
              title="Acceptance of Abstract"
              date={(<strong>December 8, 2025</strong>) as any}
              delay={200}
            />
            <DateItem
              title="Full Paper Submission"
              date={(<strong>January 10, 2026</strong>) as any}
              delay={300}
            />
            <DateItem
              title="Acceptance of Revised Paper"
              date={(<strong>March 7, 2026</strong>) as any}
              delay={400}
            />
          </div>
          ...
          >
            ...
            <ul className="space-y-2 text-gray-700">
              <li className="flex items-start">
                ...
                All deadlines end at 11:59 PM Indian Standard Time (IST) on the
                specified date.
              </li>
              <li className="flex items-start">
                <span className="inline-block w-2 h-2 bg-conference-orange rounded-full mt-2 mr-2"></span>
                Authors are encouraged to submit their papers well before the
                deadline to avoid last-minute technical issues.
              </li>
              <li className="flex items-start">
                <span className="inline-block w-2 h-2 bg-conference-orange rounded-full mt-2 mr-2"></span>
                Extensions to these deadlines are unlikely and will only be
