  ...
  return (
    ...
    >
      <div className="relative h-56 mb-4 overflow-hidden rounded-t-lg -mx-6 -mt-6">
        ...
        />
        <div className={`absolute top-4 right-4 px-3 py-1 rounded-full text-xs font-semibold ${getTypeClasses()}`}>
...
const SpeakersPage: React.FC = () => {
  ...
  const invitedPLACEHOLDER = [
    ...
    },
    {
      ...
      country: "USA",
      image: "https://images.pexels.com/photos/6250987/pexels-photo-6250987.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1",
      ...
      <div className="bg-gradient-to-r from-conference-purple/90 to-conference-orange/90 text-white py-16">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="max-w-3xl mx-auto text-lg opacity-90" data-aos="fade-up" data-aos-delay="200">
            Distinguished experts in sustainable energy and advanced manufacturing
          </p>
        </div>
      </div>
