...
const InternationalAdvisoryCommittee: React.FC = () => {
  const members = [
    ...
    "Ramji Manoharan, IIT Hyderabad, India", 
    "Randip Kumar Das, IIT(ISM) Dhanbad, India", 
    ...
    "Satish Kumar Dubey, BITS PIlani Hyderabad Campus, India", 
    ...
    "Sujeet Kumar Sinha, IIT Delhi, India", 
